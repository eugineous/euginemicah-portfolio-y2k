...
// CSV export for tables that don't need anything fancier -- opens a
// browser download via a Blob URL, no server round-trip. `rows` should
// already be flat objects (nested fields like `meta` get JSON-stringified).
