        ...
        <div className="min-h-screen bg-black text-white">
              ...
              <nav className="fixed top-0 left-0 right-0 z-50 glass-card border-b border-white/10">
                      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
                                ...
                                <div className="hidden md:flex items-center gap-8">
                                            ...
                                            <Link href="/career" className="text-[#009245]">Career</Link>
          ...
          {/* Hero */}
              <section className="pt-32 pb-16 px-6">
                      <div className="max-w-7xl mx-auto text-center">
                                <p className="text-[#009245] font-medium mb-4">CAREER HIGHLIGHTS</p>
                                <h1 className="text-4xl md:text-6xl font-bold mb-6">
                                            <span className="bg-gradient-to-r from-[#009245] to-[#FCEE21] bg-clip-text text-transparent">Building Media Excellence</span>
                                </h1>
          ...
          {/* Work History */}
              <section className="py-16 px-6">
                      <div className="max-w-7xl mx-auto">
                                <h2 className="text-3xl font-bold mb-12"><span className="bg-gradient-to-r from-[#009245] to-[#FCEE21] bg-clip-text text-transparent">Work Experience</span></h2>
                        ...
                        <div key={index} className="glass-card p-6 rounded-2xl hover:scale-[1.02] transition-transform border border-[#009245]/20">
                                        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                                                          <div>
                                                                              ...
                                                                              <p className="text-[#009245]">{job.role}</p>
                                                          </div>
          ...
          {/* Shows */}
              <section className="py-16 px-6 bg-gradient-to-b from-transparent to-[#009245]/10">
                      <div className="max-w-7xl mx-auto">
                                <h2 className="text-3xl font-bold mb-12"><span className="bg-gradient-to-r from-[#009245] to-[#FCEE21] bg-clip-text text-transparent">Shows & Series</span></h2>
                        ...
                        <div key={index} className="glass-card rounded-2xl overflow-hidden hover:scale-[1.02] transition-transform border border-[#009245]/20">
                                        ...
                                        <div className="p-6">
                                                          <div className="flex items-center gap-2 mb-2">
                                                                              <span className="px-3 py-1 bg-[#009245]/20 text-[#009245] rounded-full text-sm">{show.network}</span>
                                                          ...
                                                          <p className="text-[#009245] text-sm mt-2">{show.reach}</p>
                                        </div>
                        </div>
                      ))}
                                </div>
          ...
          {/* CTA */}
              <section className="py-20 px-6">
                      <div className="max-w-4xl mx-auto text-center glass-card p-12 rounded-3xl border border-[#009245]/20">
                                <h2 className="text-3xl font-bold mb-4"><span className="bg-gradient-to-r from-[#009245] to-[#FCEE21] bg-clip-text text-transparent">Work With Me</span></h2>
                                <p className="text-gray-400 mb-8">Hosting, interviews, shows, strategy, mentorship.</p>
                                <div className="flex flex-wrap justify-center gap-4">
                                            <Link href="/contact" className="px-8 py-3 bg-gradient-to-r from-[#009245] to-[#009245]/80 rounded-full font-semibold hover:opacity-90 transition-opacity">Start a Booking</Link>
                                            <Link href="/shows" className="px-8 py-3 glass-card rounded-full font-semibold border border-white/20 hover:bg-white/5 transition-colors">View Shows</Link>
                                </div>
                      </div>
              </section>
