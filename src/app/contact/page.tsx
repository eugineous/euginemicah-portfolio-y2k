          ...
          <div className="min-h-screen bg-[#0a0a0a] text-white">
                <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0a0a0a]/90 backdrop-blur-md border-b border-white/10">
                        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
                                  ...
                                  <div className="hidden md:flex items-center gap-8">
                                              <Link href="/" className="text-white/70 hover:text-white transition-colors">Home</Link>Link>
                                              ...
                                              <Link href="/contact" className="px-5 py-2 bg-gradient-to-r from-[#009245] to-[#00b359] rounded-full text-white font-medium">Contact</Link>Link>
                                  </div>div>
                        </div>div>
                </nav>nav>
                ...
                <section className="pt-32 pb-16 px-6">
                        <div className="max-w-7xl mx-auto">
                                  <div className="text-center mb-16">
                                              <p className="text-[#FCEE21] font-medium tracking-widest uppercase mb-4">GET IN TOUCH</p>p>
                                              <h1 className="text-4xl md:text-6xl font-bold mb-6">Let's Work Together</h1>h1>
                                              <p className="text-xl text-gray-400">Bookings, interviews, collaborations, and media inquiries.</p>p>
                                  </div>div>
                        
                                  <div className="grid md:grid-cols-2 gap-12">
                                              <div>
                                                            <h2 className="text-2xl font-bold mb-6 bg-gradient-to-r from-[#009245] to-[#FCEE21] bg-clip-text text-transparent">Contact Information</h2>h2>
                                                            <div className="space-y-6">
                                                                            <div className="p-6 rounded-2xl bg-white/5 backdrop-blur-md border border-white/10">
                                                                                              <p className="text-[#FCEE21] text-sm mb-1">Email</p>p>
                                                                                              <a href="mailto:eugine.micah@outlook.com" className="text-xl font-medium hover:text-[#009245] transition-colors">eugine.micah@outlook.com</a>a>
                                                                            </div>div>
                                                                            <div className="p-6 rounded-2xl bg-white/5 backdrop-blur-md border border-white/10">
                                                                                              <p className="text-[#FCEE21] text-sm mb-1">Phone</p>p>
                                                                                              <a href="tel:+254799886247" className="text-xl font-medium hover:text-[#009245] transition-colors">+254 799 886247</a>a>
                                                                            </div>div>
                                                                            <div className="p-6 rounded-2xl bg-white/5 backdrop-blur-md border border-white/10">
                                                                                              <p className="text-[#FCEE21] text-sm mb-1">Location</p>p>
                                                                                              <p className="text-xl font-medium">Nairobi, Kenya</p>p>
                                                                            </div>div>
                                                            </div>div>
                                              
                                                            <h3 className="text-xl font-bold mt-8 mb-4">Follow Me</h3>h3>
            ...
            { name: "X", url: "https://x.com/eugineroylandz" },
                                              ...
                                              <div className="p-8 rounded-3xl bg-white/5 backdrop-blur-md border border-white/10">
                                                            <h2 className="text-2xl font-bold mb-6 bg-gradient-to-r from-[#009245] to-[#FCEE21] bg-clip-text text-transparent">Send a Message</h2>h2>
                                                            <form className="space-y-4">
                                                                            ...
                                                                            <select className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl focus:border-[#009245] focus:outline-none transition-colors text-gray-300">
                                                                                              <option value="">Select Request Type</option>option>
                                                                                              <option>MC / Event Hosting</option>option>
                                                                                              <option>Interview Request</option>option>
                                                                                              <option>Show Collaboration</option>option>
                                                                                              <option>Speaking Engagement</option>option>
                                                                                              <option>Mentorship</option>option>
                                                                                              <option>Press Inquiry</option>option>
                                                                                              <option>Other</option>option>
                                                                            </select>select>
                                                                            <textarea placeholder="Your Message" rows={5} className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl focus:border-[#009245] focus:outline-none transition-colors resize-none"></textarea>textarea>
                ...
                <footer className="py-12 px-6 border-t border-white/10">
                        <div className="max-w-7xl mx-auto text-center">
                                  <p className="text-gray-500">© 2026 Eugine Micah. All rights reserved.</p>p>
                        </div>div>
                </footer>footer>
          </div>div>
        );
