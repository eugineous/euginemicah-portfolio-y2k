...
export const chaptersData = [
  ...
  { tag: 'Chapter V', year: '2022, present', title: 'Urban News, with Lucy Ogunde', copy: 'A youth news desk with a radical format: two people telling the truth at conversational speed, twice a week, live. No script, no retake. Kenya tuned in and stayed. Lucy fact-checks him in real time, which he describes as "a blessing, legally speaking."', aside: 'The desk chemistry is unscripted. The preparation behind it is anything but.' },
